...
public class AlertDialogLayout extends C0593g0 {
    ...
    /* renamed from: a */
    private void m2253a(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: c */
    private static int m2251c(View view) {
        int k = C0216r.m3410k(view);
        if (k > 0) {
            return k;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m2251c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: c */
    private void m2252c(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0593g0.C0594a aVar = (C0593g0.C0594a) childAt.getLayoutParams();
    ...
    /* renamed from: d */
    private boolean m2250d(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
