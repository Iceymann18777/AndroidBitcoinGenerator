...
public final class C0126a {
    /* renamed from: a */
    private static int m3729a(int i, float f) {
        return (i & 16777215) | (Math.round(Color.alpha(i) * f) << 24);
    }

    /* renamed from: a */
    public static ColorStateList m3727a(Resources resources, XmlPullParser xmlPullParser, Resources.Theme theme) {
        int next;
        ...
        if (next == 2) {
            return m3726a(resources, xmlPullParser, asAttributeSet, theme);
        }
        throw new XmlPullParserException("No start tag found");
    }

    /* renamed from: a */
    public static ColorStateList m3726a(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        String name = xmlPullParser.getName();
        if (name.equals("selector")) {
            return m3725b(resources, xmlPullParser, attributeSet, theme);
        }
        throw new XmlPullParserException(xmlPullParser.getPositionDescription() + ": invalid color state list tag " + name);
    }

    /* renamed from: a */
    private static TypedArray m3728a(Resources resources, Resources.Theme theme, AttributeSet attributeSet, int[] iArr) {
    ...
    */
    private static android.content.res.ColorStateList m3725b(android.content.res.Resources r17, org.xmlpull.v1.XmlPullParser r18, android.util.AttributeSet r19, android.content.res.Resources.Theme r20) {
        ...
        L_0x00b2:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p000a.p018g.p019d.p020c.C0126a.m3725b(android.content.res.Resources, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.content.res.Resources$Theme):android.content.res.ColorStateList");
    }
}
