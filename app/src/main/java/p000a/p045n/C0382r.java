...
class C0382r {
    ...
    /* renamed from: a */
    private static final boolean f1163a;

    /* renamed from: b */
    private static final boolean f1164b;

    /* renamed from: c */
    private static final boolean f1165c;

    static {
        boolean z = true;
        f1163a = Build.VERSION.SDK_INT >= 19;
        f1164b = Build.VERSION.SDK_INT >= 18;
    ...
    /* renamed from: a */
    public static Animator m2774a(Animator animator, Animator animator2) {
        if (animator == null) {
            return animator2;
        }
        if (animator2 == null) {
    ...
    */
    private static android.graphics.Bitmap m2773a(android.view.View r9, android.graphics.Matrix r10, android.graphics.RectF r11, android.view.ViewGroup r12) {
        ...
        L_0x00ab:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p000a.p045n.C0382r.m2773a(android.view.View, android.graphics.Matrix, android.graphics.RectF, android.view.ViewGroup):android.graphics.Bitmap");
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a */
    public static View m2772a(ViewGroup viewGroup, View view, View view2) {
        Matrix matrix = new Matrix();
        matrix.setTranslate(-view2.getScrollX(), -view2.getScrollY());
        C0341d0.m2899a(view, matrix);
        C0341d0.m2897b(viewGroup, matrix);
        ...
        Bitmap a = m2773a(view, matrix, rectF, viewGroup);
        if (a != null) {
